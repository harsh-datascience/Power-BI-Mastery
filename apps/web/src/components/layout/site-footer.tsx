...
const FOOTER_SECTIONS = [
  {
    ...
    links: [
      ...
      { label: 'DAX Fundamentals', href: '/learn/paths' },
      { label: 'M Language', href: '/learn/paths' },
      { label: 'Advanced DAX', href: '/learn/paths' },
  ...
  },
  {
    title: 'DAX Reference',
    links: [
      { label: 'Function Reference', href: '/docs/dax' },
      { label: 'Best Practices', href: '/docs/dax' },
      { label: 'DAX Queries', href: '/docs/dax' },
      { label: 'Time Intelligence', href: '/docs/dax' },
      { label: 'Filter Context', href: '/docs/dax' },
    ],
  },
  {
    title: 'M Language',
    links: [
      { label: 'Function Reference', href: '/docs/m' },
      { label: 'Language Spec', href: '/docs/m/m-spec-introduction' },
      { label: 'Data Connectors', href: '/docs/m/sql-database' },
